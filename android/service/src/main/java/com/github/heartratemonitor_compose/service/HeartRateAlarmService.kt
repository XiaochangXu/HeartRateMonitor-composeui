...
class HeartRateAlarmService : Service() {
    ...
    override fun onCreate() {
        ...
        postureDetector.setCalibration(
            PostureCalibration.fromJson(settingsRepository.getNullable(SettingsKeys.POSTURE_CALIBRATION_DATA))
        )
    ...
    private fun observeSettingsChanges() {
        ...
        serviceScope.launch {
            settingsRepository.observeNullable(SettingsKeys.POSTURE_CALIBRATION_DATA)
                .drop(1)
                .collect { json ->
                    postureDetector.setCalibration(PostureCalibration.fromJson(json))
                }
        }
    }
