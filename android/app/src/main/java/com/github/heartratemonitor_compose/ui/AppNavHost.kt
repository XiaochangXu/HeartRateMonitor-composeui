...
import com.github.heartratemonitor_compose.ui.settings.LanguageSettingsScreen
    ...
    NavDisplay(
        ...
        predictivePopTransitionSpec = { _ ->
            (slideIntoContainer(
                ...
                initialOffset = { fullWidth -> -fullWidth / 4 }
            ) + fadeIn(animationSpec = tween(easing = LinearOutSlowInEasing))) togetherWith (slideOutOfContainer(
                towards = AnimatedContentTransitionScope.SlideDirection.End,
                animationSpec = tween(easing = FastOutSlowInEasing),
                targetOffset = { fullWidth -> fullWidth }
        ...
        entryProvider = entryProvider {
            ...
            entry<AppNavKey.Language> {
                LanguageSettingsScreen(onNavigateBack = { safePopBack() })
            }
