...
// 健康区间色（心率强度分级：低=绿 / 中=黄 / 高=红）
// 用于首页心率卡片的半圆进度环按 bpm 区间着色
val HealthLowColor = Color(0xFF2E7D32)
val HealthMidColor = Color(0xFFFFA000)
val HealthHighColor = Color(0xFFC62828)
