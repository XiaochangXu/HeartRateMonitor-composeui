...
private fun GeneralSection(
    ...
    SettingsGroupCard {
        ...
        SettingsItem(onClick = { onNavigate("language") }) {
            SettingsLink(
                title = stringResource(R.string.language_settings),
                subtitle = stringResource(R.string.subtitle_language_settings),
                leadingIcon = painterResource(R.drawable.ic_language_settings),
                leadingIconContainerColor = containerColor,
                leadingIconTint = iconTint
            )
        }
