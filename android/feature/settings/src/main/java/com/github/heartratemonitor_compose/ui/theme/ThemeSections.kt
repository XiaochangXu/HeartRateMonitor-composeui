        ...
        CapsuleSegmentedButton(
            options = listOf(
                SegmentOption(
                    ...
                    iconPainter = painterResource(com.github.heartratemonitor_compose.ui.widgets.R.drawable.ic_brightness_auto),
                    value = ThemeMode.FOLLOW_SYSTEM
                ),
                SegmentOption(
                    label = stringResource(R.string.theme_mode_light),
                    iconPainter = painterResource(com.github.heartratemonitor_compose.ui.widgets.R.drawable.ic_light_mode),
                    value = ThemeMode.LIGHT
                ),
                SegmentOption(
                    label = stringResource(R.string.theme_mode_dark),
                    iconPainter = painterResource(com.github.heartratemonitor_compose.ui.widgets.R.drawable.ic_dark_mode),
