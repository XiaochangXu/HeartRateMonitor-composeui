...
internal fun UpdateCheckSheet(
    ...
    val goUpdateWithAnimation = rememberSheetDismissHandler(sheetState, onGoUpdate)
    ModalBottomSheet(
        ...
        when (state) {
            ...
            is UpdateSheetState.Available -> UpdateAvailableContent(
                ...
                onConfirm = dismissWithAnimation,
                onGoUpdate = goUpdateWithAnimation
            )
...
private fun UpdateAvailableContent(
    ...
    Column(
        ...
        Row(
            ...
            ExpressiveButton(
                label = stringResource(R.string.go_update),
                onClick = onGoUpdate
            )
        }
    }
