        ...
        IconButton(onClick = onFavoriteClick) {
            Icon(
                painter = painterResource(
                    if (isFavorite) com.github.heartratemonitor_compose.ui.widgets.R.drawable.ic_tab_favorite_filled
                    else com.github.heartratemonitor_compose.ui.widgets.R.drawable.ic_tab_favorite
                ),
