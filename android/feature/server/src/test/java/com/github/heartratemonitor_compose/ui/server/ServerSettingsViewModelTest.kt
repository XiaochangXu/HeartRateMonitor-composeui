...
class ServerSettingsViewModelTest {
    ...
    private lateinit var lanTransferSharedState: LanTransferSharedState
    ...
    fun setup() {
        ...
        lanTransferSharedState = LanTransferSharedState()
    }
    ...
    private fun createViewModel(): ServerSettingsViewModel =
        ServerSettingsViewModel(settings, IpAddressProvider(context), lanTransferSharedState)
