 ...
 *
 * 运行方式（Gradle Managed Device，无需连接真机）：
 *   ./gradlew :baselineprofile:pixel8Api37BenchmarkAndroidTest
 *
 * 本地真机运行（需连接设备，需先将 useConnectedDevices 改回 true）：
 ...
 * 生成后自动合并到 app/src/main/baselineProfiles/baseline-prof.txt
 */
